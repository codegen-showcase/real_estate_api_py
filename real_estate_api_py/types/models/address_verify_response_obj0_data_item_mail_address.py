...
class AddressVerifyResponseObj0DataItemMailAddress(pydantic.BaseModel):
    """
    ...
    address_format: typing.Optional[str] = pydantic.Field(
        alias="addressFormat", default=None
    )

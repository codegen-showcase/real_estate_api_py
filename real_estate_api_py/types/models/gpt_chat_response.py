...
class GptChatResponse(pydantic.BaseModel):
    """
    GptChatResponse
    """
    ...
    """
    Interpreted search parameters from natural language
    """
    prop_gpt_execution_time_ms: typing.Optional[str] = pydantic.Field(
        alias="propGPTExecutionTimeMS", default=None
    )
    """
    Time spent processing natural language query
    """
    ...
    """
    search_execution_time_ms: typing.Optional[str] = pydantic.Field(
        alias="searchExecutionTimeMS", default=None
    )
    """
    Time spent executing property search
    """

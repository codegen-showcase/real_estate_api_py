...
class PropertySearchParameters(typing_extensions.TypedDict):
    """
    ...
    multi_polygon: typing_extensions.NotRequired[
        typing.List[PropertySearchParametersMultiPolygonItem]
    ]
...
class _SerializerPropertySearchParameters(pydantic.BaseModel):
    """
    Serializer for PropertySearchParameters handling case conversions
    ...
    multi_polygon: typing.Optional[
        typing.List[_SerializerPropertySearchParametersMultiPolygonItem]

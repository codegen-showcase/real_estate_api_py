...
class ReportingGenerateCsvBody(typing_extensions.TypedDict):
    """
    ...
    multi_polygon: typing_extensions.NotRequired[
        typing.List[ReportingGenerateCsvBodyMultiPolygonItem]
    ]
    ...
    """
    Name for the generated CSV file
    """

    map: typing_extensions.NotRequired[typing.List[str]]
    """
    Array of field names to include in CSV export
    """

    webcomplete_url: typing_extensions.NotRequired[str]
    """
    URL to notify when CSV generation is complete
    """


class _SerializerReportingGenerateCsvBody(pydantic.BaseModel):
    """
    Serializer for ReportingGenerateCsvBody handling case conversions
    ...
    multi_polygon: typing.Optional[
        typing.List[_SerializerReportingGenerateCsvBodyMultiPolygonItem]
